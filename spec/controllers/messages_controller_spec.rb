...
describe MessagesController do
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      ...
      it "queues a job to send the email" do
        expect {
          post :create, {:message => valid_attributes}, valid_session
        }.to change(FastNotificationWorker.jobs, :size).by(1)
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved message as @message" do
        ...
        post :create, {:message => { "email" => "invalid value" }}, valid_session
        assigns(:message).should be_a_new(Message)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested message" do
        ...
        Message.any_instance.should_receive(:update).with({ "email" => "MyString" })
        put :update, {:id => message.to_param, :message => { "email" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the message as @message" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Message.any_instance.stub(:save).and_return(false)
        put :update, {:id => message.to_param, :message => { "email" => "invalid value" }}, valid_session
        assigns(:message).should eq(message)
      end
